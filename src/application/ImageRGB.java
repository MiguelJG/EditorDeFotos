...
public class ImageRGB{
	...
	public void rotation(int rot) {
        ...
        int newW = Math.abs((int) Math.floor(w * cos + h * sin)); // entero m�s grande que es menor o igual
...
//	        //
//	        int newW = (int) Math.floor(w * cos + h * sin); // entero m�s grande que es menor o igual
//	        int newH = (int) Math.floor(h * cos + w * sin);
//	        //Represents an image with 8-bit RGBA color components packed into integer pixels.
//	        BufferedImage imangen_rotado = new BufferedImage(newW , newH ,BufferedImage.TYPE_INT_ARGB);
//
//	        //"deformar" los gr�ficos -> AffineTransform
